...
// ─── RESOURCES ────────────────────────────────────────────────
// UPDATE: paste your Google Drive / Google Photos album share link here.
// The Photos card in Resources will link straight to it.
const GALLERY_URL = 'https://drive.google.com/drive/folders/YOUR_FOLDER_ID_HERE?usp=sharing'
          ...
          <FadeUp delay={0.08}>
            <div className="res-top-row">
              {RESOURCE_TOP.map(r => (
                ...
                >
                  {r.icon === 'gallery' ? (
                    <svg className="res-card-icon" width="34" height="34" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round">
